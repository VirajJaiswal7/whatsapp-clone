      ...
      >
        <div className="w-full rounded-lg p-6">
          ...
          <div className="space-y-6">
            <div className="flex flex-col items-center">
              <div className="relative group">
                ...
                <label
                  ...
                  className="absolute inset-0 bg-black/50 w-52 h-52 bg-opacity-50 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
                >
            ...
            <div
              className={`relative p-4 ${theme === "dark" ? "bg-gray-800" : "bg-white"} shadow-sm rounded-lg`}
            >
              <label
                htmlFor="name"
