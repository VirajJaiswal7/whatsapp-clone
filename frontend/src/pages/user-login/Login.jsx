      ...
      >
        ...
        {step === 1 && (
          ...
          >
              ...
              <div className="flex">
                <div className="relative w-1/3">
                  ...
                  {showDropdown && (
                    ...
                    >
                      <div
                        className={`sticky top-0 ${theme === "dark" ? "bg-gray-700 text-white" : "bg-white text-black"} p-2`}
                      >
                        <input
                          type="text"
                      ...
                      {filterCountries.map((country) => (
                        <button
                          key={country.alpha2}
                          type="button"
                          className={`w-full text-left px-3 py-2 ${theme === "dark" ? "hover:bg-gray-600 text-white" : "hover:bg-gray-100 text-black focus: outline-none focus:bg-gray-100"}`}
                          onClick={() => {
                ...
                <input
                  ...
                  className={`w-2/3 px-4 py-2 border ${theme === "dark" ? "bg-gray-700 border-gray-600 text-white" : "bg-white border-gray-300 text-black"} rounded-md focus:outline-none focus:right-2 focus:ring-green-500 ${loginErrors.phoneNumber ? "border-red-500" : ""}`}
                />
              </div>
            ...
            <div
              className={`flex items-center border rounded-md px-3 py-2 ${theme === "dark" ? "bg-gray-700 border-gray-600" : "bg-white bg-gray-300"}`}
            >
              <FaUser
            ...
            <div className="flex justify-between">
              {otp.map((digit, index) => (
                <input
                  ...
                  className={`w-12 h-12 text-center border ${theme === "dark" ? "bg-gray-700 border-gray-600 text-white" : "bg-white border-gray-300 text-gray-500"} rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${otpErrors.otp ? "border-red-500" : ""}`}
                />
              ))}
            </div>
            {otpErrors.otp && (
