...
const VideoCallModal = ({ socket }) => {
  ...
  // Memorize display the user info and it is prevent the unnessesery re-render
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
      ...
      >
        ...
        {callStatus === "calling" && (
          <button
            onClick={handleEndCall}
            className="absolute top-4 right-4 w-8 h-8 bg-gray-500 hover:bg-gray-700 rounded-full flex items-center justify-center text-white transition-colors"
          >
